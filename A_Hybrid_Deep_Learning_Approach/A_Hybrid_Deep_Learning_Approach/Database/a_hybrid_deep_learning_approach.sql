...
--
-- Host: localhost
-- Generation Time: Sep 23, 2022 at 11:43 AM
...
--
-- Database: `a_hybrid_deep_learning_approach`
--
CREATE DATABASE IF NOT EXISTS `a_hybrid_deep_learning_approach` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `a_hybrid_deep_learning_approach`;
...
('nbc0n0ri4qr3e0iy4yuaqcvdgxnfykj5', 'eyJ1c2VyaWQiOjF9:1obfW6:uVbdzAvn2q9h4NVF_iY-KtSQ6tpgvzPEqjIIOxkFnFA', '2022-10-07 10:02:42.040603'),
...
('zdvhcn2x6qqs8t98b0t4k80oqzhslnk8', 'eyJ1c2VyaWQiOjJ9:1obgtQ:lIOdxkwWG2WIM-I-UXdxWn0CujHDNA3f12bfbONI4Ms', '2022-10-07 11:30:52.154849'),
...
--
-- Table structure for table `remote_user_bottleneck_detection`
--

CREATE TABLE IF NOT EXISTS `remote_user_bottleneck_detection` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `Sender_IP` varchar(3000) NOT NULL,
  `Sender_Port` varchar(3000) NOT NULL,
  `Target_IP` varchar(3000) NOT NULL,
  `Target_Port` varchar(3000) NOT NULL,
  `Transport_Protocol` varchar(3000) NOT NULL,
  `Duration` varchar(3000) NOT NULL,
  `AvgDuration` varchar(3000) NOT NULL,
  `PBS` varchar(3000) NOT NULL,
  `AvgPBS` varchar(3000) NOT NULL,
  `TBS` varchar(3000) NOT NULL,
  `PBR` varchar(3000) NOT NULL,
  `AvgPBR` varchar(3000) NOT NULL,
  `TBR` varchar(3000) NOT NULL,
  `Missed_Bytes` varchar(3000) NOT NULL,
  `Packets_Sent` varchar(3000) NOT NULL,
  `Packets_Received` varchar(3000) NOT NULL,
  `SRPR` varchar(3000) NOT NULL,
...
--
-- Dumping data for table `remote_user_bottleneck_detection`
--

INSERT INTO `remote_user_bottleneck_detection` (`id`, `Sender_IP`, `Sender_Port`, `Target_IP`, `Target_Port`, `Transport_Protocol`, `Duration`, `AvgDuration`, `PBS`, `AvgPBS`, `TBS`, `PBR`, `AvgPBR`, `TBR`, `Missed_Bytes`, `Packets_Sent`, `Packets_Received`, `SRPR`, `Prediction`, `ID1`) VALUES
(1, '192.168.3.117', '3028', '74.54.152.11', '80', '1', '0.58', '7', '0', '148.6992481', '88', '0', '19616.79699', '44', '0', '2', '1', '0.5', 'No Botnet Attack', '10.42.0.42-106.11.94.1-50641-443-6'),
(2, '158.65.110.24', '58855', '178.73.224.2', '80', '1', '0.36', '0.413057065', '206', '192.7608696', '474', '1317', '1185.293478', '1585', '1523', '5', '5', '1', 'Botnet Attack', '10.42.0.211-10.42.0.1-45877-53-17'),
(3, '192.168.1.101', '1311', '203.73.24.75', '80', '1', '0.51', '0.688132184', '107', '103.4022989', '395', '5171', '5261.528736', '5459', '0', '7', '7', '1', 'No Botnet Attack', '216.58.219.202-10.42.0.42-443-40703-6');
...
(1, 'Harish', 'Harish123@gmail.com', 'Harish', '9535866270', 'India', 'Karnataka', 'Bangalore', '#8928,4th Cross,Malleshwaram', 'Male'),
...
(39, 'SGD Classifier', '57.16894977168949'),
(40, 'Gradient Boosting Classifier', '59.634703196347026'),
(41, 'MLPClassifier-DEEP NEURAL NETWORK(DNN)', '53.51598173515981');
...
(6, 'Botnet Attack', '33.33333333333333'),
(7, 'No Botnet Attack', '66.66666666666666');
