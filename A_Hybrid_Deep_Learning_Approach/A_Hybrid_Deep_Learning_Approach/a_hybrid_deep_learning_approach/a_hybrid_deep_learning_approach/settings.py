...
ROOT_URLCONF = 'a_hybrid_deep_learning_approach.urls'
...
WSGI_APPLICATION = 'a_hybrid_deep_learning_approach.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'a_hybrid_deep_learning_approach',
        'USER':'root',
        'PASSWORD': '',
        'HOST' :'127.0.0.1',
        'PORT' :'3306',
