"""a_hybrid_deep_learning_approach URL Configuration
...
from a_hybrid_deep_learning_approach import settings
...
urlpatterns = [
    ...
    url(r'^Predict_Attack_Type_Prediction/$', remoteuser.Predict_Attack_Type_Prediction, name="Predict_Attack_Type_Prediction"),
    ...
    url(r'^View_Prediction_Of_Attacker_Type_Ratio/$', serviceprovider.View_Prediction_Of_Attacker_Type_Ratio, name="View_Prediction_Of_Attacker_Type_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^View_Prediction_Of_Attacker_Type/$', serviceprovider.View_Prediction_Of_Attacker_Type, name="View_Prediction_Of_Attacker_Type"),
